...
import com.example.panda.myapplication.Data.enroll_list;
            ...
            public void onClick(View v) {
                        ...
                        traveler.save(new SaveListener<String>() {
                            ...
                            public void done(String objectId,BmobException e) {
                                if(e==null){
                                    Toast.makeText(EnrollActivity.this, "success submit", Toast.LENGTH_SHORT).show();
                                    try {
                                        Thread.sleep(1000);
                                    ...
                                    Toast.makeText(EnrollActivity.this, "submit failed", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
            }
