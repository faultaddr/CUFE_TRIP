...
import com.example.panda.myapplication.Tools.ZoomOutPageTransformer;

import java.util.ArrayList;

import static java.lang.Integer.MAX_VALUE;

public class LineActivitySimple extends AppCompatActivity implements OnPageChangeListener {
        ...
        public void handleMessage(Message msg)
        {
            ...
            switch(msg.what)
            {
                case 0:
                    ...
                    viewPager.setOnPageChangeListener(LineActivitySimple.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread() {
            public void run(){
                ImageView imageView1 = new ImageView(LineActivitySimple.this);
                ImageView imageView2 = new ImageView(LineActivitySimple.this);
                ImageView imageView3 = new ImageView(LineActivitySimple.this);
                ImageView imageView4 = new ImageView(LineActivitySimple.this);
